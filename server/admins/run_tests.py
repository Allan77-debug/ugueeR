#!/usr/bin/env python
"""
Script ejecutor de pruebas para la aplicación 'admins'.
...
def run_admins_tests():
    """Configura el entorno y ejecuta las pruebas de la app 'admins'."""
    ...
    if failures:
        ...
        print("✅ ¡Todas las pruebas de 'admins' pasaron exitosamente!")
